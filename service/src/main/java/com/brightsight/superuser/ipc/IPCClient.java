...
import static com.brightsight.superuser.internal.IPCMain.CMDLINE_STOP_SERVER;
import static com.brightsight.superuser.ipc.RootService.serialExecutor;
...
class IPCClient implements IBinder.DeathRecipient, Closeable {
    ...
    private static final String BROADCAST_ACTION = "com.brightsight.superuser.BROADCAST_IPC";
    private static final String IPCMAIN_CLASSNAME = "com.brightsight.superuser.internal.IPCMain";
